...
function getTimeout() {
  const timeoutParam = new URL(document.location as unknown as URL).searchParams.get("timeout")
  const timeout = parseInt(
    timeoutParam !== null ? timeoutParam : process.env.REACT_APP_TIMEOUT_MULTIPLIER || "1000");
  // const timeout = parseInt(
